...
```
For this to work, the github wiki must be setup as _github markdown_, which allows html tags and thus html comments. The generated html file is not deleted, to be able to look up the html id tags created by pandoc, which may be used to style the PDF. Writing the wiki in pure html in the first place makes things a lot easier.
